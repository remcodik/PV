      ...
      <header className="sticky top-0 z-10 bg-white border-b border-gray-200 px-6 py-4">
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          ...
          <button onClick={handleSave} disabled={saving}
            className="flex items-center gap-2 px-4 py-2 bg-teacher-ink text-white rounded-lg text-sm font-medium hover:bg-teacher-ink-dark disabled:opacity-50">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div className="col-span-2">
              ...
              <input type="text" value={caseData.witnessName} onChange={e => setField('witnessName', e.target.value)}
                className="w-full px-3 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teacher-ink" />
            </div>
            <div>
